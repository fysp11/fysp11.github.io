...
const ProjectsView: React.FC<ProjectsViewProps> = ({ projects }) => {
  ...
  const containerClasses =
    view === "grid" ? "grid grid-cols-1 gap-6 sm:grid-cols-2" : "flex flex-col gap-6"

  return (
    <section className="flex flex-col gap-7">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold">Projects</h1>
        <div className="border-border/70 bg-card/90 text-foreground/80 flex items-center gap-2 rounded-md border p-1 text-sm shadow-sm">
          <button
            data-view="grid"
