...
export default function AIGenerator({ initialPrompt }: Props) {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        <label htmlFor="prompt-input" className="block text-lg font-medium text-backgound-foreground mb-2">Your Prompt</label>
        <textarea
          id="prompt-input"
          rows={3}
              ...
              <div className="w-full p-2 rounded-md bg-card text-card-foreground shadow-lg border">
                {imageBase64s[index] ? (
                  ...
                  <div className="flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-loader animate-spin">
